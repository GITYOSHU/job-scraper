...
#
# 2026-07-31 の実測 (fetch 13,840 件 / 新規ユニーク電話 3,484 件 / 全体 3.0 円/件):
# - 電話番号の命中率は 45.6% (当初期待の 40-70% の下限)
# - 建設・設備・警備・清掃系が強い (左官 1.4 円 / 鉄筋 1.5 円 / 解体 1.6 円)
# - 美容・飲食・ナイトワーク系が弱い (整体 25.3 円 / 配達 10.7 円)
#
# クライアント予算 3-5 円/件 に収めるため、1 件あたり 5 円を超えた 14 件を除外した
# (56 → 42 キーワード)。除外リストと実測単価は tests/test_query_pools.py に固定。
# 新規獲得ペースの低下は -8% に留まり、想定費用は 124,202 円 → 104,253 円。
